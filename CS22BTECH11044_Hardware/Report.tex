...
\begin{abstract}
	In this assignment I made a Random number generator using decoder, flip flops, XOR gate, 555IC
\end{abstract}
...
\begin{enumerate}
	...
	\item Now I make the circuit for shift registers using a 4 D-Flip flops (using two 7474 IC's)
	\begin{figure}[h]
